...
let s:background = { "gui": "#282C34", "cterm": "NONE", "cterm16": "NONE" }
...
call s:h("TabLineSel", { "fg": s:blue }) " tab pages line, active tab page label
...
call s:h("gitcommitFirstLine", { "fg": s:white }) " first line of text in Git commit
call s:h("gitcommitSummary", { "fg": s:white }) " Git commit text
call s:h("gitcommitOverflow", { "fg": s:dark_yellow }) " text past the 72nd character in Git commit
